    ...
    for _ in range(num_data):
        ...
        for i in range(num_objs):
            ...
            shape =  OrderedDict([
                ...
                ("points", translated_countour_point.tolist()),
                ("group_id", None),
                ("shape_type", "polygon"),
                ("flags",{})
            ])
        ...
        filename = save_rgb.replace("jpg","json")
...
if __name__ == "__main__":
    ...
    img_counter = data_generation(target_obj_rgbs,target_obj_masks,target_obj_labels,target_obj_countour_points,target_obj_roi_dimensions,5,300,img_counter)
    img_counter = data_generation(target_obj_rgbs,target_obj_masks,target_obj_labels,target_obj_countour_points,target_obj_roi_dimensions,8,300,img_counter)
